...
d1.set_img(0,{imgtitle:"1.1 요구사항명세서",imgurl:"https://drive.google.com/file/d/1_b_BViI-nn1iG5StanUV3CqjsVdD2JbR/view?usp=sharing",imglog:"한눈에 보기 편하기 위해 이미지를 업로드 해보았습니다.",sourceurl:"https://docs.google.com/document/d/1QRlBgw9ikWA6ibnaokX77xwuoYcilPMl5GhDTCEG4Bo/edit?usp=drive_link"})//이미지타이틀


d1.set_content("목표 시스템 개발을 위한 적정한 언어를 선정하고 라이선스와 향후 지원사항을 참고하여 결정한다.")
d1.set_img(1,{imgtitle:"1.2 개발언어선정",imgurl:"https://drive.google.com/file/d/15GgAeFgW1Cxctk9PbJagUNfG2UkEU4WS/view?usp=drive_link",imglog:"자바언어기반 스프링프레임워크, html5, memberData file",sourceurl:"https://docs.google.com/document/d/1UvD1fZNL9yjLORwxgAW5vD6C-A_RwL1zcNan9RZqmys/edit?usp=drive_link"})//이미지타이틀
